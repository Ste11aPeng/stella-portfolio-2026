    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-8 group/nav">
          <Link to="/" className={`nav-link text-sm transition-all duration-700 ease-out group-hover/nav:opacity-60 group-hover/nav:blur-[0.8px] hover:!opacity-100 hover:!blur-0 ${currentPath === "/" ? "text-foreground" : ""}`} onClick={() => window.scrollTo({ top: 0, behavior: "instant" })}>product</Link>
          <Link to="/visual" className={`nav-link text-sm transition-all duration-700 ease-out group-hover/nav:opacity-60 group-hover/nav:blur-[0.8px] hover:!opacity-100 hover:!blur-0 ${currentPath === "/visual" ? "text-foreground" : ""}`}>visual</Link>
          <Link to="/about" className={`nav-link text-sm transition-all duration-700 ease-out group-hover/nav:opacity-60 group-hover/nav:blur-[0.8px] hover:!opacity-100 hover:!blur-0 ${currentPath === "/about" ? "text-foreground" : ""}`}>about</Link>
          <span className="flex items-center gap-1 transition-all duration-700 ease-out group-hover/nav:opacity-60 group-hover/nav:blur-[0.8px] hover:!opacity-100 hover:!blur-0">
