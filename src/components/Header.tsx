...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <a href="#/" className="text-foreground font-medium text-base" onClick={() => { setMenuOpen(false); window.scrollTo({ top: 0, left: 0, behavior: "instant" }); }}>Stella P.</a>
        
        {/* Desktop nav */}
        <nav className="hidden md:flex items-center gap-8">
          <a href="#/" className="nav-link text-sm" onClick={() => window.scrollTo({ top: 0, left: 0, behavior: "instant" })}>product</a>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <a href="#/" className="text-2xl text-foreground" onClick={() => { setMenuOpen(false); window.scrollTo({ top: 0, left: 0, behavior: "instant" }); }}>product</a>
