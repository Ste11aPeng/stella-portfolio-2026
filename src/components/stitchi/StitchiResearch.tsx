...
const StitchiResearch = () => {
  return <section id="research" className="pt-24">
      ...
      duration: 0.5,
      ease: easeOut
    }}>Research: Backing Decisions with Real Signals</motion.h2>
      
      
      
      
      
      <motion.p className="text-base mb-6 max-w-3xl text-foreground/80 leading-relaxed" style={{
      fontFamily: 'Manrope'
    }} initial={{
      opacity: 0,
      y: 20
      ...
      <motion.ul className="list-none mb-10 max-w-3xl space-y-4 px-[8px] py-[8px]" style={{
      fontFamily: 'Manrope'
    }} initial={{
      opacity: 0,
      y: 20
      ...
      <div className="mb-10">
        <ImageLightbox src={researchPt1Image} alt="Usability Test - User feedback about filtering difficulties" className="w-full rounded-lg shadow-sm" />
      </div>
      
      {/* Research Part 2 Image */}
      <div className="mb-8">
        <ImageLightbox src={researchPt2Image} alt="What I Found - Key insights from research" className="w-full rounded-lg shadow-sm" />
      </div>
    </section>;
};
