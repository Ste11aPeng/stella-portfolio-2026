...
const StitchiChallenge = () => {
  return <section id="challenge" className="pt-24">
      ...
      duration: 0.5,
      ease: easeOut
    }}>Challenge: Why Discovery Was Broken</motion.h2>
      ...
      {/* Challenge UI Image */}
      <div className="mb-10">
        <ImageLightbox src={challengeUIImage} alt="Current UI Problem - Filtering logic not scalable as supplier base grows" className="w-full rounded-lg shadow-sm" />
      </div>
      
      {/* Challenge Interaction Image */}
      <div className="mb-8">
        <ImageLightbox src={challengeInteractionImage} alt="Current Interaction Problem - Every click triggers a jarring reload, no filter summary" className="w-full rounded-lg shadow-sm" />
      </div>
    </section>;
};
