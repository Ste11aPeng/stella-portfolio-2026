  ...
  return (
    <section id="reflection" className="pt-24 pb-24">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, ease: easeOut }}>
        <span className="text-sm text-muted-foreground mb-3 block" style={{ fontFamily: 'Manrope' }}>reflection</span>
      ...
      <motion.p
        className="text-base mb-6 max-w-3xl text-foreground/80 leading-relaxed font-sans"
