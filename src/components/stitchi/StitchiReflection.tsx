...
const StitchiReflection = () => {
  return <section id="reflection" className="pt-24 pb-24">
      ...
      <motion.p className="text-base mb-6 max-w-3xl text-foreground/80 leading-relaxed font-sans" style={{
      fontFamily: 'Manrope'
    }} initial={{
      opacity: 0,
      y: 20
      ...
      {/* Reflection Image */}
      <div className="mb-8">
        <ImageLightbox src={reflectionImage} alt="Walkthrough video got good feedback - team collaboration" className="w-full rounded-lg shadow-sm" />
      </div>
    </section>;
};
