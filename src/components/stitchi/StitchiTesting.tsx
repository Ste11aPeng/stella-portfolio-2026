...
const StitchiTesting = () => {
  return <section id="testing" className="pt-24">
      ...
      duration: 0.5,
      ease: easeOut
    }}>From Exploration to Alignment</motion.h2>
      ...
      <div className="mb-8">
        <ImageLightbox src={testingIterationImage} alt="Iteration Archive - Agile sprint with mentor & founder's feedback" className="w-full rounded-lg shadow-sm" />
      </div>
    </section>;
};
